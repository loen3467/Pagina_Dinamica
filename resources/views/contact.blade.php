        ...
        <div class="contact-info">
            ...
            <div class="contactos_info">
                <div class="contact_information">
                    ...
                    <p>Calle Mexico N°1554 Edificio chuquiago Oficina 6, zona San pedro La Paz, Bolivia, Bolivia </p>
                </div>
                <div class="contact_information">
...
<footer class="footer">
    ...
    <p>Hola!! somos el grupo de trabajo.
    </p>
    </div>
        <ul class="r-footer">
            <li>
