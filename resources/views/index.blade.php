...
<div class="red">
    <div id="facebook">
        <a href="https://www.facebook.com/tiendavirtualintecsa" target="none" class="fab fa-facebook-f "></a>
    </div>
    <div id="instagram">
...
@section('navbar')
    ...
    <a href="#" class="logo">
        ...
        <img  class="imgtamaño" src="{{ asset('img/logo.png')}}" alt="JLDM ! Proyects">
    </a>
...
<div class="banner">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="hero-text">
                    <h4>SOMOS LOS MEJORES DISTRIBUIDORES DE TECNOLOGIA, <span>UNICOS DE BOLIVIA</span></h4>
                    <br>
                    <br>
                    <h1 class="tipeo1">INTECSA</h1>
                    <h1 class="tipeo2"><span class="type">luigi</span></h1>
...
<footer class="footer">
    ...
    <p>¡No te quedes sin la tuya!
Si buscas una computadora, laptop, impresora o fotocopiadora con garantía real y completamente nueva, ¡Contáctanos!

Para adquirir nuestros productos, contáctanos por WhatsApp pulsando el botón a continuación:
            ...
            <h2>Social</h2>
                <ul class="box">
                    <li class="button_social">
                        ...
                        <a href="https://www.facebook.com/tiendavirtualintecsa/" target="_blank">Facebook</a>
                    </li>
                    <li class="button_social">
                    ...
                    <li class="button_social">
                        ...
                        <a href="https://www.facebook.com/tiendavirtualintecsa" target="_blank">Instagram</a>
                    </li>
                    <li class="button_social">
